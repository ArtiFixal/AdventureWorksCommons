...
public partial class AdventureWorksContext : DbContext
{
    ...
    public virtual DbSet<NewProductStaging> NewProductStagings { get; set; }
    ...
    public virtual DbSet<StockChangeLog> StockChangeLogs { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.InvoiceId).HasName("PK__Invoice__D796AAD5312556F8");
        ...
        {
            entity.HasKey(e => e.InvoiceLineId).HasName("PK__InvoiceL__0D760AF90013DA5B");

            entity.HasOne(d => d.Invoice).WithMany(p => p.InvoiceLines).HasConstraintName("FK__InvoiceLi__Invoi__70FDBF69");
        });
        ...
        modelBuilder.Entity<NewProductStaging>(entity =>
        {
            entity.ToTable("NewProductStaging", "prs", tb => tb.HasTrigger("trg_InsertProductValidation"));
        ...
        modelBuilder.Entity<StockChangeLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__StockCha__5E5499A872190993");
